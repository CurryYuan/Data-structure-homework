...
QT_MOC_LITERAL(3, 17, 5), // "node*"
QT_MOC_LITERAL(4, 23, 4) // "info"

    },
    "MyLabel\0clicked\0\0node*\0info"
};
...
void MyLabel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->clicked((*reinterpret_cast< node*(*)>(_a[1]))); break;
        default: ;
        }
